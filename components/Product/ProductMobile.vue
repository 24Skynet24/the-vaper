  ...
  <article class="product-mobile-wrap">
    <header class="flex-column">
      ...
      <div class="flex-between">
        <h3><b>{{ productInfo.price.price }} ₽</b></h3>
    ...
    <div class="parent">
      <client-only>
        ...
        >
          <swiper-slide v-for="(item, id) in productInfo.images" :key="`mobile_product_${id}`">
            <div class="img-wrap no-selection">
              <img alt="" :src="item.img" v-if="item.img">
      ...
      <div class="icons">
        <div class="like">
          <svg v-if="!productInfo.like" @click="productInfo.like = true" width="28" height="26" viewBox="0 0 28 26" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <svg v-else @click="productInfo.like = false" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
